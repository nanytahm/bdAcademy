...
namespace NetCoreTestInnovar.BusinessService;
    ...
    public class ExamnBusinessService
    {
        private ExamnDataService _examnDataService;
    public ExamnBusinessService(ExamnDataService examnDataService){
        _examnDataService =examnDataService;
    }
