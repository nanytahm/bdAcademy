...
namespace NetCoreTestInnovar.BusinessService;
    ...
    public class ProfesionalSchoolBusinessService
    {
        private ProfesionalSchoolDataService _profesionalSchoolDataService;
    public ProfesionalSchoolBusinessService(ProfesionalSchoolDataService profesionalSchoolDataService){
        _profesionalSchoolDataService = profesionalSchoolDataService;
    }
