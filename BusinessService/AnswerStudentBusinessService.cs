...
namespace NetCoreTestInnovar.BusinessService;
    ...
    public class AnswerStudentBusinessService
    {
        private AnswerStudentDataService _answerStudentDataService;
    public AnswerStudentBusinessService(AnswerStudentDataService answerStudentDataService){
        _answerStudentDataService = answerStudentDataService;
    }
